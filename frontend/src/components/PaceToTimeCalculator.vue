      ...
      <div>
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              v-model.number="form.paceMinutes"
              type="number"
              min="2"
              max="20"
          ...
          <div>
            ...
            <input
              v-model.number="form.paceSeconds"
              type="number"
              min="0"
              max="59"
              class="input-field text-center text-lg font-semibold"
        ...
        <p class="text-sm text-gray-500 mt-2">
          当前配速：{{ formatPace(form.paceMinutes, form.paceSeconds) }}/公里
        </p>
      </div>
...
const handleSubmit = () => {
  emit('calculate', {
    ...
    paceMinutes: form.paceMinutes || 0,
    paceSeconds: form.paceSeconds || 0
  })
}
</script>
